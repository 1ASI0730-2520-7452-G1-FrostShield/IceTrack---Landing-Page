const translations = {
    es: {
        ...
        icetrack_in_action: "IceTrack en Acción",
        ...
        icetrack_in_action_title: "IceTrack en Acción",
        icetrack_action_description_1: "Descubre cómo IceTrack transforma la gestión de tus equipos de refrigeración. Nuestro sistema innovador te permite monitorear en tiempo real, recibir alertas proactivas y optimizar el mantenimiento preventivo.",
        icetrack_action_description_3: "Para dueños de negocios, facilita la solicitud de servicios técnicos y el seguimiento de los mismos. Para compañías proveedoras de servicios, ofrece herramientas robustas para la gestión eficiente de sus operaciones y equipos.",
        icetrack_action_description_2: "Con IceTrack, aseguras la integridad de tu inventario, reduces costos operativos y extiendes la vida útil de tus activos. ¡Mira cómo funciona en este video!",
        testimonials_title: "Testimonios",
        testimonial_1: `"Gracias a IceTrack, las alertas automáticas nos han salvado de perder mercancía valiosa. La plataforma nos da una tranquilidad que no habíamos tenido antes."`,
        author_1: "Ana Rodríguez",
        position_1: "Gerente de Operaciones",
        testimonial_2: `"Como técnico, IceTrack es una herramienta esencial. Me permite llevar un control detallado del mantenimiento de cada cliente y generar reportes profesionales al instante."`,
        author_2: "Luis Pérez",
        position_2: "Técnico de Refrigeración",
        testimonial_3: `"Con el monitoreo continuo de IceTrack, hemos logrado optimizar el uso de energía de nuestros equipos y reducir costos operativos de forma significativa."`,
        author_3: "Sofía Gómez",
        position_3: "Propietaria de Restaurante",
        testimonial_4: `"La curva de aprendizaje para mi equipo fue mínima. La interfaz es tan intuitiva que ahora somos mucho más ágiles en la planificación y ejecución de mantenimientos preventivos."`,
        author_4: "Carlos Morales",
        position_4: "Supervisor de Mantenimiento",

        contact_title: "Contáctanos",
        contact_subtitle: "Completa el formulario y te contactaremos para coordinar una demostración gratuita.",
    ...
    en: {
        ...
        benefits: "Benefits",
        about_us: "About Us",
        icetrack_in_action: "IceTrack in Action",
        ...
        icetrack_in_action_title: "IceTrack in Action",
        icetrack_action_description_1: "Discover how IceTrack transforms the management of your refrigeration equipment. Our innovative system allows you to monitor in real-time, receive proactive alerts, and optimize preventive maintenance.",
        icetrack_action_description_3: "For business owners, it facilitates the request and tracking of technical services. For service provider companies, it offers robust tools for efficient management of their operations and teams.",
        icetrack_action_description_2: "With IceTrack, you ensure the integrity of your inventory, reduce operational costs, and extend the lifespan of your assets. Watch how it works in this video!",
        testimonials_title: "Testimonials",
        testimonial_1: `"Thanks to IceTrack, the automatic alerts have saved us from losing valuable merchandise. The platform gives us a peace of mind we hadn't had before."`,
        author_1: "Ana Rodríguez",
        position_1: "Operations Manager",
        testimonial_2: `"As a technician, IceTrack is an essential tool. It allows me to keep detailed control of each client's maintenance and generate professional reports instantly."`,
        author_2: "Luis Pérez",
        position_2: "Refrigeration Technician",
        testimonial_3: `"With IceTrack's continuous monitoring, we have managed to optimize our equipment's energy usage and significantly reduce operational costs."`,
        author_3: "Sofía Gómez",
        position_3: "Restaurant Owner",
        testimonial_4: `"The learning curve for my team was minimal. The interface is so intuitive that we are now much more agile in planning and executing preventive maintenance."`,
        author_4: "Carlos Morales",
        position_4: "Maintenance Supervisor",
        contact_title: "Contact Us",
        contact_subtitle: "Fill out the form and we will contact you to arrange a free demonstration.",
        full_name: "Full Name",
        email: "Email Address",
